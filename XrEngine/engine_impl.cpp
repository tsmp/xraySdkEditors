...
engine_impl::engine_impl() : m_input_receiver(xr_new<IInputReceiver>()),
...
property_holder *engine_impl::current_frame_property_holder()
{
	...
	return (
		((XrWeatherEditor::environment::weathers::time &)(*environment.Current[0])).object());
}
...
property_holder *engine_impl::blend_frame_property_holder()
{
	...
	return (
		((XrWeatherEditor::environment::weathers::time &)(*environment.CurrentEnv)).object());
}
...
property_holder *engine_impl::target_frame_property_holder()
{
	...
	return (
		((XrWeatherEditor::environment::weathers::time &)(*environment.Current[1])).object());
}
